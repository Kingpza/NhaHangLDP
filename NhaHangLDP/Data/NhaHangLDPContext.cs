...
public partial class NhaHangLDPContext : DbContext
{
    public NhaHangLDPContext(DbContextOptions<NhaHangLDPContext> options)
        : base(options)
    {
    }
    ...
    public virtual DbSet<VwAccountInfo> VwAccountInfos { get; set; }

    public virtual DbSet<VwAppSetting> VwAppSettings { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<QrorderDetail>(entity =>
        {
            ...
            entity.Property(e => e.ItemStatus)
                ...
                .HasMaxLength(50)
                .HasDefaultValue("Pending");
            entity.Property(e => e.QrorderId).HasColumnName("QROrderId");
            entity.Property(e => e.Quantity).HasDefaultValue(1);
            entity.Property(e => e.UnitPrice).HasColumnType("decimal(18, 2)");
        ...
        modelBuilder.Entity<ReturnBill>(entity =>
        {
            ...
            entity.Property(e => e.ReturnBillId).HasColumnName("ReturnBillID");
        ...
        modelBuilder.Entity<ReturnBillDetail>(entity =>
        {
            ...
            entity.Property(e => e.ReturnBillDetailId).HasColumnName("ReturnBillDetailID");
        ...
        modelBuilder.Entity<VwAccountInfo>(entity =>
        {
            entity
                .HasNoKey()
        ...
        modelBuilder.Entity<VwAppSetting>(entity =>
        {
            entity
                .HasNoKey()
